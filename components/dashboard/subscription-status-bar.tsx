    ...
    <div className="relative w-full" ref={containerRef}>
      ...
      >
        <div className="flex items-center gap-3 overflow-x-auto no-scrollbar flex-1 min-w-0">
          ...
          {/* Plan status + renewal (subscribers only) */}
      ...
      {/* ── Dropdown Panel ── */}
      {open && (
        <div className="absolute left-0 right-0 top-full mt-2 z-50 rounded-xl border border-border/60 bg-background shadow-xl p-3 animate-in fade-in slide-in-from-top-2 duration-200">
          {hasActiveAccess && subscription?.current_period_end ? (
            /* Subscriber: show subscription status card only (credits already in top bar) */
            ...
            /* Non-subscriber: show credits history */
