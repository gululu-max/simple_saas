...
export default function SignUpForm() {
  ...
  // ✅ session 监听已提升到 AuthModalProvider，这里不再需要
  ...
  const handleSignUp = async (e?: React.FormEvent) => {
    ...
    // 1. 消除邮箱枚举安全漏洞
    // 2. 减少一次网络往返
    // Supabase signUp 本身就会返回 "already registered" 错误，由 getFriendlyError 处理
      ...
      <div className="flex flex-col items-center justify-center gap-5 py-4 px-2 text-gray-900 animate-in fade-in zoom-in duration-300">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="bg-amber-50 text-amber-800 text-xs font-medium px-3 py-2.5 rounded-lg inline-block border border-amber-200 shadow-sm mt-2">
            ⚠️ Don&apos;t close this page. Click the link in your email to
            continue.
          </div>
        </div>
        ...
        <p className="text-[11px] text-gray-400 text-center mt-2 px-4 leading-relaxed italic">
          Tip: Clicking the link in your email completes your registration. Once
          confirmed, you can close this window and sign in directly.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="text-gray-900">
      ...
      <div className="grid gap-5">
        ...
        {/* ✅ 用 form 标签包裹 — 让密码管理器正确识别 */}
        <form className="grid gap-4" onSubmit={handleSignUp} autoComplete="on">
