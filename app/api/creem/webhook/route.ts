...
const CREDITS_MAP: Record<string, { type: 'subscription' | 'package', amount: number }> = {
  // === 📅 订阅套餐 ===
  "prod_5rb8HwRBFYrkLIk4Jo0zk4": { type: 'subscription', amount: 40 },   // Starter
  "prod_1OW6mmHO9dwQv7tcLvoWqE": { type: 'subscription', amount: 200 },  // Pro
  "prod_5lQJo4e8joxLuDMZXzaNAX": { type: 'subscription', amount: 500 },  // Ultra

  // === 💰 单次购买积分包 (⚠️ 请把这里的 prod_xxx 换成你真实的商品 ID) ===
  "prod_45VZKvDlwmOeCaZmtpVVht":  { type: 'package', amount: 25 },   // $5  (25 credits)
  "prod_7BZsaTaYuNSxV3J351zJEU": { type: 'package', amount: 100 },  // $12 (100 credits)
  "prod_40nACa3LIp8EPw46bHJyyE": { type: 'package', amount: 300 },  // $25 (300 credits)
};
